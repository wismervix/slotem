...
export default function PrivacyPolicyPreview() {
    ...
    const selectedVersion =
        POLICY_VERSIONS.find((v) => v.id === currentVersionId) ||
        POLICY_VERSIONS[0];
                ...
                <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
                    <div className="space-y-4">
                        ...
                        <p className="max-w-3xl text-base leading-relaxed text-zinc-600 sm:text-lg dark:text-zinc-300">
                            Your trust is our most valuable asset. This policy
                            outlines how Slotem handles your personal data with
                            the transparent assurance and strict enterprise
                            security you expect from a professional scheduling
                            partner.
                        </p>
                    </div>
                    {/* Shield graphic */}
                    ...
                    <div className="space-y-4 lg:w-1/3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
                                Select any past release to see what security
                                guidelines, subprocessors, or policies were
                                updated.
                            </p>
                        </div>
