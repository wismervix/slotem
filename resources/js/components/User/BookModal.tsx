...
const PRESETS = [
    {
        ...
        duration: 45,
        icon: Smile,
        desc: 'General dental health inspection, cleaning and consult with Dr. Sarah Jenkins.',
        colorClass: 'border-l-4 border-primary bg-primary-container/10',
    },
    {
        ...
        duration: 60,
        icon: Sparkles,
        desc: 'Therapeutic deep muscle manipulation with expert therapist Mia Wright.',
        colorClass: 'border-l-4 border-tertiary bg-tertiary-fixed/20',
    },
    {
        title: 'General Health Checkup',
        provider: 'Apex Medical Suite',
        category: 'general' as const,
        price: 75,
        duration: 30,
        icon: Activity,
        desc: 'Annual health assessment, blood pressure screen, and consultation.',
        colorClass: 'border-l-4 border-blue-500 bg-blue-100/30',
    },
    {
        title: 'Skin Treatment Extra',
        provider: 'Radiant Skin Spa',
        category: 'wellness' as const,
        price: 110,
        duration: 50,
        icon: Heart,
        desc: 'Revitalizing dermatologist assessment and facial hydration cure.',
        colorClass: 'border-l-4 border-purple-500 bg-purple-100/30',
    },
];
                    ...
                    {showSuccess ? (
                        <div className="flex flex-col items-center justify-center space-y-4 py-8 text-center">
                            ...
                            <p className="max-w-sm text-sm text-secondary">
                                ...
                                <strong>{currentPreset.title}</strong> at{' '}
                                <strong>{currentPreset.provider}</strong> has
