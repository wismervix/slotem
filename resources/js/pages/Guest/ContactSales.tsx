...
export default function ContactSalesPage() {
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        if (!data.agree_privacy) {
            setSubmitError(
                "You must agree to Slotem's Privacy Policy to request a demo.",
            );
            return;
        }
        if (
            data.company_size === 'Select Size' ||
    ...
    return (
        <GuestLayout>
            ...
            <main className="flex-1 dark:bg-slate-900">
                <div className="mx-auto grid max-w-7xl items-start gap-12 px-6 pt-44 sm:pt-20 pb-12 lg:grid-cols-2 lg:gap-16 lg:pt-32 lg:pb-20">
                    ...
                    <section className="space-y-10">
                        <div className="space-y-5">
                            <h1 className="text-4xl leading-none font-black tracking-tight text-slate-900 lg:text-5xl dark:text-white">
                                Let's build a better booking experience
                                together.
                            </h1>
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="px-4 text-xs leading-relaxed text-slate-400 dark:text-slate-500">
                                                ...
                                                <strong>{data.company}</strong>{' '}will
