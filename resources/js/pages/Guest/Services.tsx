        ...
        <GuestLayout>
            ...
            <main className="mx-auto min-h-screen max-w-7xl px-6 py-10 pt-24">
                ...
                <div className="mb-16 flex justify-center">
                    <div className="flex w-full max-w-2xl items-center">
                        ...
                        <div className="flex flex-1 flex-col items-center">
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-600 font-bold text-white ring-4 ring-indigo-200">
                                1
                            </div>
                ...
                <section className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {/* Card 1 */}
                    <div className="relative flex flex-col rounded-3xl border border-slate-200 bg-white p-8 transition hover:border-indigo-500 dark:border-slate-700 dark:bg-slate-900">
                        <div className="absolute top-6 right-6 rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300">
                            Popular
                        </div>

                        <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100 text-indigo-600 dark:bg-indigo-500/10">
                        ...
                        <div className="mt-auto flex items-center justify-between">
                            ...
                            <button className="rounded-xl bg-indigo-600 px-6 py-2 font-semibold text-white transition hover:bg-indigo-500">
                                Select
                            </button>
                        </div>
                    </div>
                    ...
                    {/* Card 2 */}
                    <div className="flex flex-col rounded-3xl border border-slate-200 bg-white p-8 transition hover:border-indigo-500 dark:border-slate-700 dark:bg-slate-900">
                        <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100 text-indigo-600 dark:bg-indigo-500/10">
                    ...
                    {/* Deluxe Package */}
                    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 transition hover:border-indigo-500 md:col-span-2 dark:border-slate-700 dark:bg-slate-800">
                        <div className="flex h-full flex-col md:flex-row">
                            ...
                            <div className="flex flex-1 flex-col p-8">
                                ...
                                <div className="mt-auto flex items-center justify-between">
                                    ...
                                    <button className="rounded-2xl bg-indigo-600 px-8 py-3 font-semibold text-white transition hover:bg-indigo-500">
                                        Book Package
                                    </button>
                                </div>
                            </div>
                ...
                <section className="mt-20 border-t border-slate-200 pt-16 dark:border-slate-700">
                    <div className="grid gap-10 md:grid-cols-3">
                        ...
                        <div className="flex items-start gap-4">
                            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100 text-indigo-600 dark:bg-indigo-500/10">
